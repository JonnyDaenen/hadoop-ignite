...
class GumboRunner:
    ...
    def get_opts(self):
        d = {
            ...
            "nogroup" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.NoneGrouper",
            "ng" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.NoneGrouper",
            "allgroup" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.AllGrouper -Dgumbo.engine.mapOutputGroupingOptimizationOn=false -Dgumbo.engine.reduceOutputGroupingOptimizationOn=false",
            "allgroup+map" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.AllGrouper -Dgumbo.engine.mapOutputGroupingOptimizationOn=true -Dgumbo.engine.reduceOutputGroupingOptimizationOn=false",
            "allgroup+map+red" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.AllGrouper -Dgumbo.engine.mapOutputGroupingOptimizationOn=true -Dgumbo.engine.reduceOutputGroupingOptimizationOn=true",
            "agmr" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.AllGrouper -Dgumbo.engine.mapOutputGroupingOptimizationOn=true -Dgumbo.engine.reduceOutputGroupingOptimizationOn=true",
            "allgroup128" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.AllGrouper -Dgumbo.engine.mapOutputGroupingOptimizationOn=true -Dgumbo.engine.reduceOutputGroupingOptimizationOn=true -Dgumbo.engine.hadoop.reducersize_mb=128",
            "allgroup64" : "-Dgumbo.engine.mapOutputGroupingClass=gumbo.engine.general.grouper.policies.AllGrouper -Dgumbo.engine.mapOutputGroupingOptimizationOn=true -Dgumbo.engine.reduceOutputGroupingOptimizationOn=true -Dgumbo.engine.hadoop.reducersize_mb=64",
